// @ts-nocheck
import { formatForDisplay, isValidTimestamp } from '../utils/timestampUtils';
import type { ClaudeJsonMessage } from '@snowtree/core/types';

type MessageContent = string | Array<{ type: string; text?: string; [key: string]: any }>;
